...
const Header = ()=>{
    ...
    <div className="flex justify-between bg-white shadow-lg my-0 mx-[12.333px]">
        <div className="logo flex flex-col items-center object-contain">
            <Link to="/">
                <img src={LOGO_URL} alt="logo" className="w-[48.2px] h-[48.2px]  object-contain" />
            </Link>
        ...
        <div className="flex items-center">
            <ul className="flex p-4 m-4 ">
                ...
                <li className="px-4 text-base md:text-lg font-[16px] hover:text-[#e03618]">
                    ...
                    -<span className="text-green-300"> {cartItems.reduce((total, item) => total + item.quantity, 0)}</span>
                    </Link>
                </li>
                <button className="login-btn px-4 text-base md:text-lg font-[16px] hover:text-[#e03618]" 
                onClick={()=>
                    //btn="logout"
